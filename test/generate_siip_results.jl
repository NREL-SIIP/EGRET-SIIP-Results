...
#####################################################
sys_DA = build_system(PSITestSystems, "RTS_GMLC_sys")
remove_component!(sys_DA, get_component(RenewableDispatch, sys_DA, "212_CSP_1"))
#=
#####################################################
# RTS-GMLC System using PSY
# Using source data
...
solver = optimizer_with_attributes(Xpress.Optimizer, "MIPRELSTOP" => 0.01, "OUTPUTLOG" => 1)
...
# Simulation
sim_folder = mkpath(joinpath(pwd(), "data", "Results"))
sim = Simulation(
    name = "RTS-GMLC",
    steps = 14,
    problems = problems,
...
results_dier = mkdir(joinpath("data", "CSV_Results"))
# UC Results
